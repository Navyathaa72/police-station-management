...
<body>
                     <div class="login-box">
                        <h2>KNOW CRIMINAL DETAILS BY MONTH</h2>
                        <div class="user-box">

                        <form action="" method="GET">
                                    <input type="text" name="datee" value="<?php if(isset($_GET['datee'])){echo $_GET['datee'];} ?>" class="form-control">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['datee']))
                                    {
                                        ...
                                        $query = "SELECT * FROM criminal c, cases d WHERE c.CASE_ID=d.CASE_ID AND c.MONTH ='$userid'";
